...
function Lap({ number, interval, fastest, slowest}){
  ...
  return(  //Timer style={[lapStyle, styles.lapTimer]}
   ...
   render() {
     ...
     return (
       <View style = {styles.container}>
         <Timer 
            interval ={laps.reduce((total, curr) => total + curr, 0) + timer} //curr ats value to total amount which initially is zero.. incr total value
            style={styles.timer}
          />
         {laps.length == 0 && (
         <ButtonsRow>
         ...
         {laps.length > 0  && start ==  0 && (
          <ButtonsRow>
           ...
           />
           <RoundButton
             title= 'Start'  //This 'start' is the 'resume button'
             color= '#50D167' 
             background= '#1B361F'
             onPress = {this.resume}
            />
